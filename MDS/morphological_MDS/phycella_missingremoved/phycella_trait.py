...
for i in ["flws_n", "perig_form", "color", "est_form", "coron_typ"]:
	traitdataset[i].astype(str)

# Format measurement columns
for i in ["scp_h", "scp_lat", "flws_n", "spt_long", "spt_lat", "ped_long", "ped_lat", "ov_long", "ov_lat", "perig_long", "perig_diam", "tub_lat", "tep1_long", "tep1_lat", "tep3_long", "tep3_lat", "fil1_long", "fil2_long", "ant_long", "est_long"]:
	traitdataset[i].astype(str)
...
for a in ["scp_h", "scp_lat", "flws_n", "spt_long", "spt_lat", "ped_long", "ped_lat", "ov_long", "ov_lat", "perig_long", "perig_diam", "tub_lat", "tep1_long", "tep1_lat", "tep3_long", "tep3_lat", "fil1_long", "fil2_long", "ant_long", "est_long"]:
	traitdataset[a].replace('', numpy.NaN, inplace=True)

# For discrete data, 0 is a valid datum, so use unoccupied number 
for a in ["flws_n", "perig_form", "color", "est_form", "coron_typ"]:
	traitdataset[a].replace('', numpy.NaN, inplace=True)


# Jaccard distance, i.e. identical is 0, maximally different is 1
traitdataset_matrix = traitdataset[["flws_n", "perig_form", "color", "est_form", "coron_typ"]].to_numpy()
...
traitdataset_matrix = traitdataset[["scp_h", "scp_lat", "flws_n", "spt_long", "spt_lat", "ped_long", "ped_lat", "ov_long", "ov_lat", "perig_long", "perig_diam", "tub_lat", "tep1_long", "tep1_lat", "tep3_long", "tep3_lat", "fil1_long", "fil2_long", "ant_long", "est_long"]].to_numpy()
