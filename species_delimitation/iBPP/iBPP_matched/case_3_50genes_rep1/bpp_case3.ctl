...
* two spaces between name and sequence (tab alone isn't enough)
    ...
    * Threads = 1 1 1 * Can only use when estimating theta
    ...
    seqfile = combined.case3.traitmatched.phy
    Imapfile = imap.phyc.case3.traitmatched.txt 
    ...
    species&tree = 10      P21 P15 P31 P6 P34 P5 P27 P3 P1 P4
                    3 4 3 5 3 2 3 3 3 5
                    (P21,(((P15,P31),(P6,P34)),(P5,(P27,(P3,(P1,P4))))));
