...
* two spaces between name and sequence (tab alone isn't enough)
    ...
    * Threads = 1 1 1 * Can only use when estimating theta
    ...
    seqfile = combined.case4.traitmatched.phy
    Imapfile = imap.phyc.case4.traitmatched.txt 
    outfile = out.case4.txt 
    mcmcfile = mcmc.case4.txt 
    traitfile = trait_phycella.case4.csv
    ...
    species&tree = 14       P11 P10 P8 P9 P12 P13 P20 P14 P33 P35 P32 P17 P19 P18
                    3 3 3 3 3 2 4 4 3 3 2 3 3 5
                    ((P11,(P10,(P8,P9))),(P12,((P13,(P20,(P14,P33))),(P35,(P32,(P17,(P19,P18)))))));
