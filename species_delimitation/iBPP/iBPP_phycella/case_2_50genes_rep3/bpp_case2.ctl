...
* two spaces between name and sequence (tab alone isn't enough)
    ...
    * Threads = 1 1 1 * Can only use when estimating theta
    ...
    seqfile = combined.case2.traitmatched.phy
    Imapfile = imap.phyc.case2.traitmatched.txt 
    outfile = out.case2.txt 
    mcmcfile = mcmc.case2.txt 
    traitfile = trait_phycella.case2.csv
    ...
    species&tree = 7     P22 P26 P23 P24 P25 P30 P2
                    1 2 2 2 2 3 3
                    ((P22,(P26,(P23,(P24,P25)))),(P30,P2));
